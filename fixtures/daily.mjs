...
const make = ({ id, category, zh, en, synopsisZh, synopsisEn, source, url, date, confidence, exam337, exam902, image, locale = 'en' }) => ({
  id, category, title: { zh, en }, synopsis: { zh: synopsisZh, en: synopsisEn },
  source: { id: source.toLowerCase().replace(/[^a-z0-9]+/g, '-'), name: source, url, locale, credibility: 'primary-or-editorial' },
