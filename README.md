...
- `daily [--date YYYY-MM-DD]`: collect, select, enrich six items, synthesize through a seventh structured model call, strictly validate, atomically publish, and queue/advance one Feishu document delivery.
